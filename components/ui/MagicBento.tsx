...
const getCardIcon = (title?: string) => {
  switch (title) {
    ...
    case 'NeetBot Assistant':
      return 'spark' as const;
    case 'AI Hints & Debug':
      return 'search' as const;
    case 'Company Tagged Problems':
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (event: MouseEvent) => {
      ...
      cards.forEach((card) => {
        ...
        updateCardGlowProperties(cardEl, event.clientX, event.clientY, glowIntensity, spotlightRadius);
      });
            ...
            >
              <div className="magic-bento-card__header">
                ...
                <span className="magic-bento-card__icon" aria-hidden="true">
                  <Glyph name={getCardIcon(card.title)} className="h-4 w-4" />
                </span>
              </div>
